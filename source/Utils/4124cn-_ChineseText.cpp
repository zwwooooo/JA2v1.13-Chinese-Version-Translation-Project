...
STR16		zOptionsToggleText[] = 
{
	...
	L"允许敌人嘲笑", // Changed from "Enemies Drop all Items" - SANDRO
	L"允许高仰角榴弹发射",	//"High angle Grenade launching",
	L"允许即时潜行模式", // Changed from "Restrict extra Aim Levels" - SANDRO
	...
	L"替代子弹图像", // Show alternate bullet graphics (tracers) // TODO.Translate
...
STR16	zOptionsScreenHelpText[] =
{
	...
	L"当启用时，敌人会偶尔评论某些行动。", // Changed from Enemies Drop All Items - SANDRO
...
STR16 New113Message[] =
{
	...
	L"%s 偷窃成功!", // MINTY - Changed "on" to "at": More natural English
	L"%s 行动点数不足无法偷窃.", // MINTY - Changed "had not" to "did not": More natural English
	L"你希望在给XX包扎之前先动手术吗? (你可以治愈XX 的生命点数.)", // MINTY - Changed "make" to "perform": More natural English
	L"你希望在给xx动手术吗?? (你可以治愈XX 的生命点数.)",// MINTY - Changed "make" to "perform": More natural English
	L"你希望动手术吗? (%i 个病人)",// MINTY - Changed "make" to "perform": More natural English
	L"你希望给这个伤员先做手术吗?",// MINTY - Changed "make" to "perform": More natural English
	L"自动进行急救并且做必须的手术还是不需要?",
	L"给 %s 的手术完成了.",
	L"%s 胸部中弹，丧失了1点最高生命值!",
	L"%s 胸部中弹，丧失了X点最高生命值!",
	L"%s 重新获得了1点失去的 %s",
	L"%s 重新获得了 %d 点失去的 %s",
	L"你的斥候技能使你成功地避免了敌人的伏击!", // MINTY - Changed "you to be ambushed" to "an ambush": More natural English
	L"你的斥候技能使你成功地避开了一群凶恶的血猫!",
	L"%s 下身中弹，滚地哀嚎!!",
	//////////////////////////////////////////////////////////////////////////////////////
	L"注意: 敌人尸体被发现!!!",
	L"%s [%d rnds]\n%s %1.1f %s",
...
STR16 pSkillTraitBeginIMPStrings[] =
{
	...
	L"在下面，你必须依照你作为雇佣兵的专业选择特长。注意你只能选择两种一般特长或者一种专家级特长。",
	L"你可以只选择一个专家特长或者干脆什么也不选，作为回报你会得到额外的能力点数。注意电子、左右开弓和伪装是没有专家级的。",
	// For new major/minor traits 用于新的主/副特长
	L"在下面，你必须依照你作为雇佣兵的专业选择特长。在第一页你可以最多选择两个主特长，以反映你在小队中扮演的主要角色。在第二页将有副特长的列表供你选择，以反映你个人的倾向。",
...
STR16 sgAttributeSelectionText[] = 
{
	...
	L"在下一页你必须设定你的各项基本能力，例如健康、敏捷、灵巧、力量和智慧，这些能力不能低于 %d.",
	L"其余的是“技能”，它可以设定为零，表示你完全不通晓这种技能。",
	L"所有点数在起始时都设为最低值，注意有一些项目是被你之前的特长选择影响而位于特定数值的，你不能够将它们再降低。",
};
